// Home.jsx - Page d'accueil FM2023
...
                    
                    {/* Remplacement de l'ancienne ligne par celle-ci : */}
...
📍 Répartition par Position
            ...
            <ResponsiveContainer width="100%" height={300}>
              <BarChart
                data={positions}
                layout="vertical" // La clé pour un graphique horizontal
                margin={{ top: 5, right: 30, left: 30, bottom: 5 }} // Marge à gauche pour les étiquettes
              >
                <CartesianGrid strokeDasharray="3 3" />
                
                {/* L'axe X (horizontal) affiche les nombres */}
                <XAxis type="number" />
                
                {/* L'axe Y (vertical) affiche les catégories (positions) */}
                <YAxis 
                  dataKey="position" 
                  type="category" 
                  width={100} // Augmentez si les étiquettes sont longues
                  tick={{ fontSize: 12 }} // Ajuste la taille de la police
                />
                
                <Tooltip />
                
                <Bar dataKey="count">
                  {/* On garde la même logique de couleurs pour chaque barre */}
...
            Il combine la <strong>visualisation de données</strong>, l'<strong>analyse statistique</strong> 
            et le <strong>développement web full stack</strong> pour explorer les données de Football Manager 2023.
          </p>
